// <copyright file="Path.cs" company="EnsoulSharp">
...
namespace EnsoulSharp.SDK
{
    ...
    public class GamePath
    {
        ...
        public static class PathTracker
        {
            ...
            ///     <see cref="StoredPath" />
            /// </returns>
            public static StoredPath GetCurrentPath(AIBaseClient unit)
            {
            ...
            public static double GetMeanSpeed(AIBaseClient unit, double maxT)
            {
            ...
            public static List<StoredPath> GetStoredPaths(AIBaseClient unit, double maxT)
            {
                List<StoredPath> value;
