// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ColoredColorPicker.cs" company="EnsoulSharp">
...
namespace EnsoulSharp.SDK.Core.UI.IMenu.Skins.Colored
{
    ...
    using EnsoulSharp.SDK.Core.UI.IMenu.Abstracts;
    ...
    using Utilities = EnsoulSharp.SDK.Core.UI.IMenu.Utilities;
