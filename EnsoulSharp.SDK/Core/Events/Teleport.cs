// <copyright file="Teleport.cs" company="EnsoulSharp">
...
namespace EnsoulSharp.SDK
{
    ...
    public class TeleportEventArgs : EventArgs
    {
        ...
        /// </summary>
        public AIBaseClient Object { get; internal set; }
    ...
    internal interface ITeleport
    {
        ...
        /// </returns>
        int GetDuration(AIBaseClientTeleportEventArgs args);
        ...
        /// </returns>
        bool IsTarget(AIBaseClientTeleportEventArgs args);
    ...
    internal class RecallTeleport : ITeleport
    {
        ...
        ///     Duration of the teleport.
        /// </returns>
        public int GetDuration(AIBaseClientTeleportEventArgs args)
        {
            var duration = 0;
        ...
        ///     returns where the teleport is target.
        /// </returns>
        public bool IsTarget(AIBaseClientTeleportEventArgs args)
        {
            return false;
        }
    ...
    internal class ShenTeleport : ITeleport
    {
        ...
        public bool IsTarget(AIBaseClientTeleportEventArgs args)
        {
            return !string.Equals(args.RecallName, "shenrchannelmanager", StringComparison.InvariantCultureIgnoreCase);
        }
