// <copyright file="Orbwalker.cs" company="EnsoulSharp">
...
namespace EnsoulSharp.SDK
{
    ...
    public sealed class Orbwalker : OrbwalkerBase<OrbwalkingMode, AttackableUnit>
    {
        ...
        public override bool CanAttack(float extraWindup)
        {
            ...
            if (GameObjects.Player.CharacterName.Equals("Graves"))
            {
            ...
            else if (GameObjects.Player.CharacterName.Equals("Jhin") && GameObjects.Player.HasBuff("JhinPassiveReload"))
            {
                return false;
            }
        ...
        public override bool CanMove(float extraWindup, bool disableMissileCheck)
        {
            ...
            if (GameObjects.Player.CharacterName.Equals("Rengar")
                && (GameObjects.Player.HasBuff("RengarQ") || GameObjects.Player.HasBuff("RengarQEmp")))
            {
        ...
        public override void Move(Vector3 position)
        {
            ...
            if (position.Distance(GameObjects.Player.Position) > maximumDistance)
            {
                position = GameObjects.Player.Position.Extend(
                    position,
