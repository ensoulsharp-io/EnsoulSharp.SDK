// <copyright file="AbilityPower.cs" company="EnsoulSharp">
    ...
    public class AbilityPower : IWeightItem
    {
        ...
        public float GetValue(AIHeroClient hero)
        {
            ...
            return hero.FlatMagicDamageMod
                   * (100 / (100 + (this.averageMr * hero.PercentMagicPenetrationMod) - hero.FlatMagicPenetrationMod - hero.MagicLethality));
        }
