namespace EnsoulSharp.SDK.Core.Wrappers.Damages
{
    ...
    public static class DamageMastery
    {
        ...
        public static Mastery GetCunning(this AIHeroClient hero, Cunning cunning)
        {
            return hero.GetMastery(MasteryPage.Cunning, (int)cunning);
        }

        public static Mastery GetFerocity(this AIHeroClient hero, Ferocity ferocity)
        {
        ...
        internal static bool IsMoveImpaired(this AIBaseClient hero)
        {
